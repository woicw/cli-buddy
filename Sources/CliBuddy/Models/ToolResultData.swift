...
// Structured models for Claude Code tool-result payloads. Each case
// mirrors a block shape from the official tool_result schema; fields
// are the public surface Anthropic documents, not cli-buddy-specific.
